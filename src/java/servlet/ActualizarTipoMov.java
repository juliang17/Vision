 ...
 * @author santy
 */
@WebServlet(name = "ActualizarTipoMov", urlPatterns = {"/ActualizarTipoMov"})
public class ActualizarTipoMov extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String respuestaRegistrada = miTipoMovDAO.Modificartipo_mov(miTipoMov);
