 ...
 * @author santy
 */
@WebServlet(name = "RegistroMedioPago", urlPatterns = {"/RegistroMedioPago"})
public class RegistroMedioPago extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (BanderaEstado.equals("Correcto")) {
            String respuestaRegistrada = MedioPagoDAO.AdicionarMedios_de_pago(MedioPago);
            System.out.println("Res " + respuestaRegistrada);
            System.out.println("Res " + respuestaRegistrada.length());
            if (respuestaRegistrada.length() == 0) {
                out.println("<script type=\"text/javascript\">");
                out.println("alert('" + "Medio de pago registrado con éxito." + "');");
