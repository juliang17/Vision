...
@WebServlet(name = "RegistrarTipoMovimiento", urlPatterns = {"/RegistrarTipoMovimiento"})
public class RegistrarTipoMovimiento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (BanderaEstado.equals("Correcto")) {
            String respuestaRegistrada = TIPOMOVDAO.adicionarTipoMovimiento(mitipomov);
