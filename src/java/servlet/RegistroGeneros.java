 ...
 * @author santy
 */
@WebServlet(name = "RegistroGeneros", urlPatterns = {"/RegistroGeneros"})
public class RegistroGeneros extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String Genero = request.getParameter("descripciongenero");
        ...
        if (BanderaEstado.equals("Correcto")) {
            ...
            if (respuestaRegistrada.length() == 0) {
                ...
                out.println("alert('" + "Genero Usuario registrado con éxito." + "');");
                out.println("window.location.href = '/VISION/vista/Formularios/GestionGenero.jsp';");
                out.println("</script>");
            } else {
                out.println("<script type=\"text/javascript\">");
