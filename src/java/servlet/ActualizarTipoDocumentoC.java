 ...
 * @author santy
 */
@WebServlet(name = "ActualizarTipoDocumentoC", urlPatterns = {"/ActualizarTipoDocumentoC"})
public class ActualizarTipoDocumentoC extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String descripciontipodoccontable = request.getParameter("descripciontipodoccontable");
        ...
        System.out.println(" Descripcion: " + descripciontipodoccontable);
        String respuestaRegistrada = mi_tipo_doc_dao.ModificarTipoDocContable(mi_tipo_doc);
