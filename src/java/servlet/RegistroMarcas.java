 ...
 * @author santy
 */
@WebServlet(name = "RegistroMarcas", urlPatterns = {"/RegistroMarcas"})
public class RegistroMarcas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String Marca = request.getParameter("descripcionmarca");
        String BanderaEstado = request.getParameter("BanderaRegistro");
        
        MarcaDAO marca_dao = new MarcaDAO();
        marca mi_marca = new marca();
        
        mi_marca.setDescripcionmarca(Marca);
        ...
        if (BanderaEstado.equals("Correcto")) {
            ...
            if (respuestaRegistrada.length() == 0) {
                ...
                out.println("alert('" + "Marca registrada con éxito." + "');");
