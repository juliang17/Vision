...
public class pruebaListareferencia {
    ...
    public static void main(String[] args) {
        ...
        mi_referencia_de_pago = referencia_de_pago_dao.ListadoReferenciaDePago(1, "");

        int size = mi_referencia_de_pago.size();
        System.out.println("<table border=\"1\"><tr><td>idreferenciadepago</td><td>descripcion</td><td>fechadepago</td>><td>medio_de_pago_idMedioDePago_</td> ");

        for (referencia_de_pago R : mi_referencia_de_pago) {

            System.out.println("<tr>");
            System.out.println("<td>" + R.getIdreferenciadepago() + "</td>");
            System.out.println("<td>" + R.getDescripcion() + "</td>");
