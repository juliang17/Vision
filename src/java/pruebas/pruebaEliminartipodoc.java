...
public class pruebaEliminartipodoc {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<tipo_doc_contable> listado_tipo_doc_contable = tipo_doc_contable_dao.ListadoTipoDocContable(0, "");
        ...
        listado_tipo_doc_contable = tipo_doc_contable_dao.ListadoTipoDocContable(0, "");
        for (tipo_doc_contable T : listado_tipo_doc_contable) {
            System.out.println(" id : " + T.getIdtipodoccontable() + " descripción : " + T.getDescripciontipodoccontable());
        }
    }
