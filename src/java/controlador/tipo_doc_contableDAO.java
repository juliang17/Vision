...
public class tipo_doc_contableDAO {
    ...
    public String ModificarTipoDocContable(tipo_doc_contable tipoDocContable) {
        ...
        try {
            ...
            sentencia.setString(3, tipoDocContable.getIdtipodoccontable());
    ...
    public ArrayList<tipo_doc_contable> ListadoTipoDocContable(String idtipodoccontable ,String descripciontipodoccontable) {
