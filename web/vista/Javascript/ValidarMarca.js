function validarMarca() {
    ...
    var Marca = document.getElementById("txt_descripcionmarca_Reg").value;
    ...
    if (Marca == '') {
        ...
        alert("La marca no puede estar vacio");
        resultado = 'Error';
    }
...
function realizarBusqueda() {
    ...
    window.location.href = '/VISION/vista/Formularios/GestionMarca.jsp?buscando=' + textoBuscado.trim() + '&';
}
