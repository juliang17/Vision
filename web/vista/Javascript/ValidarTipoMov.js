function validarTipoMov() {
    ...
    var TipoMov = document.getElementById("txt_descripcionTipoMov_Reg").value;
    ...
    if (TipoMov == '') {
        ...
        alert("El tipó de movimiento no puede estar vacio");
        resultado = 'Error';
    }
...
function realizarBusqueda() {
    ...
    window.location.href = '/VISION/vista/Formularios/GestionTipoMov.jsp?buscando=' + textoBuscado.trim() + '&';
}
