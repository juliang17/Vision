function validarRoles() {
    ...
    var ROLES = document.getElementById("txt_descripcionrol_Reg").value;


    console.log("-- Informacion a validar -- ");
    console.log("EstadoUsuario : " + ROLES);
...
function realizarBusqueda() {
    ...
    window.location.href = '/VISION/vista/Formularios/GestionRoles.jsp?buscando=' + textoBuscado.trim() + '&';
}
