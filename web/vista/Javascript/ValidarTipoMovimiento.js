function validarTipoMov() {
    ...
    var TipoMovimiento = document.getElementById("txt_descripciontipomov_Reg").value;
...
function realizarBusqueda() {
    ...
    window.location.href = '/VISION/vista/Formularios/GestionTipoMovimiento.jsp?buscando=' + textoBuscado.trim() + '&';
}
