function RegistroEstado() {
    ...
    var descripcionestadousuario = $('#txt_descripcionestadousuario_reg').val();

    console.log('Información a validar');
    console.log('descripcionestadousuario: ' + descripcionestadousuario + ".");

    if (descripcionestadousuario == '') {
        alert('El estado usuario no puede estar vacio');
        resultado = 'Error';
    } else {
        resultado = 'correcto';
    }
...
function realizarBusqueda()
{
    ...
    window.location.href = '/VISION/Formularios/GestionEstadoUsuario.jsp?buscando=' + textoBuscado.trim() + '&';
}
