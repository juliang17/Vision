function RegistroGeneroo() {

    var resultado = 'correcto';
    var descripciongenero = $('#txt_descripciongenero_reg').val();

    console.log('Información a validar');
    console.log('descripciongenero: ' + descripciongenero + ".");
...
function realizarBusqueda()
{
    ...
    window.location.href = '/VISION/Formularios/GestionGenero.jsp?buscando=' + textoBuscado.trim() + '&';
}
