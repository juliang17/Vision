function validarGenero() {
    ...
    var Genero = document.getElementById("txt_descripciongenero_Reg").value;
...
function realizarBusqueda() {
    ...
    window.location.href = '/VISION/vista/Formularios/GestionGenero.jsp?buscando=' + textoBuscado.trim() + '&';
}
