function RegistroUnidadmedida() {

    var resultado = 'correcto';
    var descripcionunidadmedida = $('#txt_descripcionunidadmedida_reg').val();

    console.log('Información a validar');
    console.log('descripcionunidadmedida: ' + descripcionunidadmedida + ".");
...
function realizarBusqueda()
{
    ...
    window.location.href = '/VISION/Formularios/GestionUnidadmedida.jsp?buscando=' + textoBuscado.trim() + '&';
}
