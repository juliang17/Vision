    ...
    <body onload="visualizaOculta('<%=request.getParameter("Vista")%>');">
        ...
        <div id="Registrar" class="container bd-example d-none">
            ...
            <form action="/VISION/RegistroMedioPago" method="post" onsubmit="return validarMedioPago()" class="row g-3">
                ...
                <div class="form-floating col-md-6" >
                    <input type="text" name="referencia_pago" class="form-control" placeholder="Digite la referencia de pago" id="txt_referenciapago">
            ...
            <div id="Actualizar" class="bd-example d-none">
                ...
                <form action="/VISION/ActualizarMedioPago" method = "post">
                    ...
                    <div class ="form-group">
                        ...
                        <input type="text" class="form-control" readonly name="referencia_pago" value="<%=request.getParameter("referencia_pago")%>"/>
                    </div>
                    <div id="ControlRegistro" class="bd-example d-none">
                    ...
                    <div>
                        ...
                        <div id="Tabla_categorias">
                            ...
                            <% mediodepagoDAO medio_de_pago_dao = new mediodepagoDAO();
                                ...
                                out.println("<table class='table table-dark table-striped table-hover table-bordered'><tr><td>Descripcion</td><td>Referencia</td><td>Editar</td><td>Eliminar</td></tr>");
                                for (medio_de_pago M : mi_medio_de_pago) {
                                    out.println("<tr>");
                                    out.println("<td>" + M.getDescripcionmediodepago() + "</td>");
                                    out.println("<td>" + M.getReferencia_pago() + "</td>");
                                    out.println("<td>" + "<button type = 'submit' class='btn btn-primary form-control btn btn-login' value='Actualizar'name='Actualizar'onclick='SetIdConsulta(" + M.getIdMedioDePago() + ")'/>" + "" + "<i class='fas fa-pencil-alt'></i>" + "</button>" + "</td>");
                                    out.println("<td>" + "<button type = 'submit' class='btn btn-danger form-control btn btn-login' value= 'Eliminar'name='Eliminar'onclick='SetIdConsulta(" + M.getIdMedioDePago() + ")'/>" + "" + "<i class='fas fa-trash-alt'></i>" + "</button>" + "</td>");
                                    out.println("</tr>");
                                }
                                out.println("</table>");
                            %>
