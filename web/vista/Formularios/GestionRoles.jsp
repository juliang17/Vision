...
<html>
    ...
    <body onload="visualizaOculta('<%=request.getParameter("Vista")%>');">
        ...
        <div id="Registrar" class="d-none">
            ...
            <form action="/VISION/RegistroRoles" method="post" onsubmit="return RegistroRoles()">
                <h5>Descripcion </h5>
                <input type="text" name="descripcionrol" class="form-control" placeholder="descripcion rol" id="txt_descripcionrol_reg"> 
                <br>
